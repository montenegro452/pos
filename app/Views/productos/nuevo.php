      ...
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <?php } ?>
            <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>productos/insertar" data-confirm="¿Desea guardar el nuevo producto?" data-confirm-title="Guardar producto">
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-12 col-sm-6">
                    ...
                    <input class="form-control" type="number" name="existencias" id="existencias" min="0" required>
                  </div>
                </div>
              </div>
              <div class="form-group">
