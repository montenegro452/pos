      ...
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <form method="POST" action="<?= base_url('categorias/actualizar') ?>" autocomplete="off" data-confirm="¿Desea guardar los cambios de la categoria?" data-confirm-title="Actualizar categoria">
